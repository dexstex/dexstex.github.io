...
async function init(data) {
    ...
    if (json['discord_status'] === "online") {
        ...
        let textarray = ["Doing nothing", "Probably in school", "Hi :3", "Dead X_X", "PC exploded", "Probably touching grass"]
        var rand = textarray[Math.random() * textarray.length | 0]
        div.innerHTML = (rand)
    }
...
async function updatepresence() {
    ...
    if (json['discord_status'] == "offline") {
